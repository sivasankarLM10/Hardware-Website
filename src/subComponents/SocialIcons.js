...
const SocialIcons = (props) => {
    return (
        <Icons>
            ...
            >
                <NavLink style={{color:'red'}}  target="_blank"   to={{pathname:"https://github.com/codebucks27"}}>
                    <Github width={25} height={25} fill='green'/>
                </NavLink>
            </motion.div>
            <motion.div
            initial={{transform:"scale(0)"}}
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://twitter.com/code_bucks"}}>
                    <Twitter width={25} height={25} fill='green'/>
                </NavLink>
            </motion.div>
            <motion.div
            initial={{transform:"scale(0)"}}
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://facebook.com/codebucks27"}}>
                    <Facebook width={25} height={25} fill='green' />
                </NavLink>
            </motion.div>
            <motion.div
            initial={{transform:"scale(0)"}}
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://youtube.com"}}>
                    <YouTube width={25} height={25} fill='green' />
                </NavLink>
            </motion.div>
